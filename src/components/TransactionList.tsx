    ...
    return (
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800">
            <button
                ...
                className="w-full flex items-center justify-between text-lg font-bold mb-4 dark:text-white pb-2 border-b border-zinc-100 dark:border-zinc-800 transition-colors hover:text-blue-600 dark:hover:text-blue-400"
            >
